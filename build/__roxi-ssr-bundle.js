(() => {
  ...
  // dist/build/_fallback-3d5929f5.js
  var require_fallback_3d5929f5 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => fallback_3d5929f5_default2
    });
    function v2(s2) {
    ...
    var fallback_3d5929f5_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, x2, v2, s, {});
      }
    };
    var fallback_3d5929f5_default2 = fallback_3d5929f5_default;
  });

  // dist/build/bases-fdead142.js
  var require_bases_fdead142 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => bases_fdead142_default2
    });
    function u2(t2) {
  ...
  var require_layout_52561d9e = __commonJS((exports) => {
    ...
    var layout_52561d9e_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, u2, c2, s, {});
      }
    };
    var layout_52561d9e_default2 = layout_52561d9e_default;
  });
  ...
  var _e = {root: true, ownMeta: {preload: "proximity"}, children: [{isFallback: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/_fallback", component: () => Promise.resolve().then(() => require_fallback_3d5929f5()).then((t2) => t2.default)}, {isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/bases", id: "_bases", component: () => Promise.resolve().then(() => require_bases_fdead142()).then((t2) => t2.default)}, {isIndex: true, isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/index", id: "_index", component: () => Promise.resolve().then(() => require_index_65947364()).then((t2) => t2.default)}], isLayout: true, meta: {preload: "proximity", recursive: true, prerender: true}, path: "/", id: "__layout", component: () => Promise.resolve().then(() => require_layout_52561d9e()).then((t2) => t2.default)};
