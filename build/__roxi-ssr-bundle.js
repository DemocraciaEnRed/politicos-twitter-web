(() => {
  ...
  // dist/build/_fallback-951895a8.js
  var require_fallback_951895a8 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => fallback_951895a8_default2
    });
    function v2(s2) {
    ...
    var fallback_951895a8_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, x2, v2, s, {});
      }
    };
    var fallback_951895a8_default2 = fallback_951895a8_default;
  });

  // dist/build/bases-81382451.js
  var require_bases_81382451 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => bases_81382451_default2
    });
    function u2(t2) {
  ...
  var require_index_b2f3e8cf = __commonJS((exports) => {
    ...
    var index_b2f3e8cf_default = class extends X {
      constructor(t2) {
        super(), Z(this, t2, x2, p2, s, {});
      }
    };
    var index_b2f3e8cf_default2 = index_b2f3e8cf_default;
  });

  // dist/build/_layout-f4d4686a.js
  var require_layout_f4d4686a = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => layout_f4d4686a_default2
    });
    function c2(s2) {
      let t2;
    ...
    var layout_f4d4686a_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, u2, c2, s, {});
      }
    };
    var layout_f4d4686a_default2 = layout_f4d4686a_default;
  });
  ...
  var _e = {root: true, ownMeta: {preload: "proximity"}, children: [{isFallback: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/_fallback", component: () => Promise.resolve().then(() => require_fallback_951895a8()).then((t2) => t2.default)}, {isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/bases", id: "_bases", component: () => Promise.resolve().then(() => require_bases_81382451()).then((t2) => t2.default)}, {isIndex: true, isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/index", id: "_index", component: () => Promise.resolve().then(() => require_index_b2f3e8cf()).then((t2) => t2.default)}], isLayout: true, meta: {preload: "proximity", recursive: true, prerender: true}, path: "/", id: "__layout", component: () => Promise.resolve().then(() => require_layout_f4d4686a()).then((t2) => t2.default)};
