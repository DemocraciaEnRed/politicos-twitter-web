(() => {
  ...
  // dist/build/_fallback-d64631e5.js
  var require_fallback_d64631e5 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => fallback_d64631e5_default2
    });
    function v2(s2) {
    ...
    var fallback_d64631e5_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, x2, v2, s, {});
      }
    };
    var fallback_d64631e5_default2 = fallback_d64631e5_default;
  });

  // dist/build/bases-d215b20c.js
  var require_bases_d215b20c = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => bases_d215b20c_default2
    });
    function u2(t2) {
  ...
  var require_index_032dab62 = __commonJS((exports) => {
    ...
    function d2(t2) {
      ...
      return {c() {
        ...
        t3 && m(e2), t3 && m(a2), t3 && m(r2), t3 && m(d3), t3 && m(x3), t3 && m(p2), t3 && m(m2), t3 && m(u2), t3 && m(g2), t3 && m(f2), t3 && m(b2), t3 && m(h2), t3 && m(v2), t3 && m(w2), t3 && m(y2), t3 && m(j2), t3 && m(q2), t3 && m(k2), t3 && m(T2);
      }};
    }
    function x2(t2) {
      return Mt.title = "Pol\xEDticos en Twitter", Mt.description = "Observatorio de redes sociales", [];
    }
    var index_032dab62_default = class extends X {
      constructor(t2) {
        super(), Z(this, t2, x2, d2, s, {});
      }
    };
    var index_032dab62_default2 = index_032dab62_default;
  });

  // dist/build/_layout-f2062055.js
  var require_layout_f2062055 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => layout_f2062055_default2
    });
    function c2(s2) {
      let t2;
    ...
    var layout_f2062055_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, u2, c2, s, {});
      }
    };
    var layout_f2062055_default2 = layout_f2062055_default;
  });
  ...
  var _e = {root: true, ownMeta: {preload: "proximity"}, children: [{isFallback: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/_fallback", component: () => Promise.resolve().then(() => require_fallback_d64631e5()).then((t2) => t2.default)}, {isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/bases", id: "_bases", component: () => Promise.resolve().then(() => require_bases_d215b20c()).then((t2) => t2.default)}, {isIndex: true, isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/index", id: "_index", component: () => Promise.resolve().then(() => require_index_032dab62()).then((t2) => t2.default)}], isLayout: true, meta: {preload: "proximity", recursive: true, prerender: true}, path: "/", id: "__layout", component: () => Promise.resolve().then(() => require_layout_f2062055()).then((t2) => t2.default)};
