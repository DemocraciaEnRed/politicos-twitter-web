(() => {
  ...
  // dist/build/_fallback-35099af8.js
  var require_fallback_35099af8 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => fallback_35099af8_default2
    });
    function v2(s2) {
    ...
    var fallback_35099af8_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, x2, v2, s, {});
      }
    };
    var fallback_35099af8_default2 = fallback_35099af8_default;
  });

  // dist/build/bases-2038b6a3.js
  var require_bases_2038b6a3 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => bases_2038b6a3_default2
    });
    function u2(t2) {
  ...
  var require_index_fa3e1ef8 = __commonJS((exports) => {
    ...
    var index_fa3e1ef8_default = class extends X {
      constructor(t2) {
        super(), Z(this, t2, p2, x2, s, {});
      }
    };
    var index_fa3e1ef8_default2 = index_fa3e1ef8_default;
  });

  // dist/build/_layout-5f557d05.js
  var require_layout_5f557d05 = __commonJS((exports) => {
    __markAsModule(exports);
    __export(exports, {
      default: () => layout_5f557d05_default2
    });
    function c2(s2) {
      let t2;
    ...
    var layout_5f557d05_default = class extends X {
      constructor(s2) {
        super(), Z(this, s2, u2, c2, s, {});
      }
    };
    var layout_5f557d05_default2 = layout_5f557d05_default;
  });
  ...
  var _e = {root: true, ownMeta: {preload: "proximity"}, children: [{isFallback: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/_fallback", component: () => Promise.resolve().then(() => require_fallback_35099af8()).then((t2) => t2.default)}, {isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/bases", id: "_bases", component: () => Promise.resolve().then(() => require_bases_2038b6a3()).then((t2) => t2.default)}, {isIndex: true, isPage: true, meta: {recursive: true, preload: "proximity", prerender: true}, path: "/index", id: "_index", component: () => Promise.resolve().then(() => require_index_fa3e1ef8()).then((t2) => t2.default)}], isLayout: true, meta: {preload: "proximity", recursive: true, prerender: true}, path: "/", id: "__layout", component: () => Promise.resolve().then(() => require_layout_5f557d05()).then((t2) => t2.default)};
